...
my $coding_seq = middle::cal::connect_exons($nucleo_seq, %exons);
...
print <<__EOF;
<h3>Coding Sequence with aligned amino acid sequence. </h3>
__EOF
...
<td><b> Codon </b></td>
<td><b> Codon Frequency %</b> </td>
<td><b> Codon Ratio %</b></td>
</tr>
__EOF
...
<p align='center'>Enter your sequence below to find out whether your sequence can cut the DNA in the 5' and 3' regions and not in between. </p>
<br/ >
<p align='center'>
