...
# entered by the user through a subroutine in the queries.pm module which then        
# uses it to query the database for the relevant data.                                
#########################################################################################
...
# queries.pm module. The result page displays alternative gene identifiers.	       	
# Presuming that the user may use chromosomal location as a gene id, the following script   	
